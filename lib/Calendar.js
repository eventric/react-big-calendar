...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'components', 'formats', 'messages', 'style', 'className', 'elementProps', 'date', 'length', 'currentTimeIndicatorVisible']);
