...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        currentTimeIndicatorVisible = _props.currentTimeIndicatorVisible,
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'components', 'formats', 'messages', 'style', 'className', 'elementProps', 'getNow', 'date', 'length', 'currentTimeIndicatorVisible']);
