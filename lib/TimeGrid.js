...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(range, events, today) {
    ...
    return range.map(function (date, idx) {
      var daysEvents = events;

      return _react2.default.createElement(_DayColumn2.default, _extends({}, _this3.props, {
        min: _dates2.default.merge(date, min),
        max: _dates2.default.add(_dates2.default.merge(date, min), _dates2.default.diff(max, min), 'milliseconds'),
  ...
  TimeGrid.prototype.renderHeader = function renderHeader(range, events, width) {
    ...
    var _ref3 = this.state || {},
        isOverflowing = _ref3.isOverflowing;
        ...
        _react2.default.createElement(
          'div',
          {
            ref: function ref(_ref4) {
              return _this4._gutters[0] = _ref4;
            },
            className: 'rbc-label rbc-header-gutter',
            style: { width: width }
          },
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function (date, i) {
      ...
      return _react2.default.createElement(
        ...
        {
          key: i,
          className: (0, _classnames2.default)('rbc-header', className, _dates2.default.eq(date, today, 'date') && 'rbc-today'),
  ...
  TimeGrid.prototype.calculateScroll = function calculateScroll(props) {
    var min = props.min,
        max = props.max,
  ...
  TimeGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
    ...
    var timeIndicator = this.timeIndicator;
...
TimeGrid.propTypes = {
  ...
  currentTimeIndicatorVisible: _propTypes2.default.bool
};
